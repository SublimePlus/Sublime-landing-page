...
export function Testimonials() {
  return (
    <section className="bg-pine/[0.03] py-28">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {testimonials.map((t, i) => (
            <Reveal key={t.name} delay={i * 0.1}>
              <figure className="h-full rounded-2xl bg-white p-7 shadow-sm">
                ...
                <figcaption className="mt-5 border-t border-pine/10 pt-4">
                  <p className="text-sm font-semibold text-pine">{t.name}</p>
